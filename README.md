...
The [release and dependency policy](docs/29-PROJECT-OPERATIONS.md) defines
maintenance checks; the [pilot guide](docs/28-ADOPTION-PILOT.md) includes a
plan/results template for participating organizations.
...
[Review collaboration and impact](docs/31-REVIEW-WORKSPACE.md) add application-local
