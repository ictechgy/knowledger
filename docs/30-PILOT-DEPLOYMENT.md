...
[첫 연동 조합 선정](35-PILOT-INTEGRATION-SELECTION.md)은 공식 문서 기반 구현 후보를
Confluence Cloud·Slack Bot DM·text-embedding-3-small로 정리한다. 실제 조직이 사용하는
제품·계정·반출 정책의 확정과 구현/배포는 별도다.
